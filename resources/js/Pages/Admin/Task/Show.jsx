    ...
    return (
        ...
        user={auth.user}
            header={
                ...
                <Link href={route('task.edit',task.id)} className='bg-emerald-500 py-1 px-3 text-white rounded shadow transition-add hover:bg-emerald-600'>Edit</Link>
                </div>  
            }
        >

 <Head title={`Task Dtails"${task.name}"`} />
