        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 border-b-2 border-gray-500">
              <tr className="text-nowrap">
                  <TableHeading name="id" sortChanged={sortChanged} is_sorted={is_sorted} sortable="true">ID</TableHeading>
                  <TableHeading name="Image" sortChanged={sortChanged} is_sorted={is_sorted} sortable="flase">Image</TableHeading>
                  {!hideProjectCoulmn && <TableHeading name="project_id" sortChanged={sortChanged} is_sorted={is_sorted} sortable="true">Project</TableHeading> }
                  <TableHeading name="name"  sortChanged={sortChanged} is_sorted={is_sorted} sortable="true">Name</TableHeading>
                  <TableHeading name="status"  sortChanged={sortChanged} is_sorted={is_sorted} sortable="true">Status</TableHeading>
                  <TableHeading name="created_at"  sortChanged={sortChanged} is_sorted={is_sorted} sortable="true">Create Date</TableHeading>
                  <TableHeading name="due_date"  sortChanged={sortChanged} is_sorted={is_sorted} sortable="true">Due Date</TableHeading>
                  <TableHeading name="Created By" sortChanged={sortChanged} is_sorted={is_sorted} sortable="flase">Created By</TableHeading>
                  
                  <TableHeading name="Actions" sortChanged={sortChanged} is_sorted={is_sorted} sortable="flase">Actions</TableHeading>
